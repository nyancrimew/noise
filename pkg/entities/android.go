...
type AndroidVersion struct {
	...
	Code    AndroidVersionCode
}

type AndroidVersionCode int

const (
	BASE AndroidVersionCode = iota + 1
	BASE_1_1
	CUPCAKE
	DONUT
	ECLAIR
...
func (v *AndroidVersionCode) GetReleases() []AndroidRelease {
	return Releases[*v]
}

type AndroidRelease string

var Releases = map[AndroidVersionCode][]AndroidRelease{
	BASE:                   {"1"},
	BASE_1_1:               {"1.1"},
	CUPCAKE:                {"1.5"},
	DONUT:                  {"1.6"},
